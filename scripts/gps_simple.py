...
def load_gps():
    # UI labels
    latitude = M5TextBox(88, 10, "lat-coord.", lcd.FONT_Default, 0xFFFFFF,
                         rotate=90)
    longitude = M5TextBox(63, 10, "long-coord.", lcd.FONT_Default, 0xFFFFFF,
                          rotate=90)
    gps_logger = M5TextBox(15, 5, "GPS: ", lcd.FONT_Default, 0xFFFFFF,
                           rotate=90)
    sat_logs = M5TextBox(15, 42, "Connecting...", lcd.FONT_Default, 0xFFFFFF,
                         rotate=90)
    wait(2)
    sat_logs.setText('')
